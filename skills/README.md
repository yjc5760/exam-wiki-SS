...
|---|---|---|
| 定位 | **命題分析**（考什麼） | 練題**之前**的觀念建立 |
| 內容 | 出題頻率、考點結構、考點漂移、考題清單、命題風險 | 物理直覺、原理圖解、公式來源 |
| 時機 | 決定練題順序、考前押題 | 第一次接觸該單元 |
...
|---|---|---|---|
| 定位 | **命題分析** | 練題前建立觀念 | **背誦決策** |
| 回答的問題 | 這個單元**考什麼**？ | 這條公式為什麼成立？ | 這條公式**要不要背**？ |
| 時機 | 決定練題順序、考前押題 | 第一次接觸該單元 | 排讀書計畫、決定背誦優先序 |
